...
minBtn.MouseButton1Click:Connect(function()
    ...
    local targetY = isMinimized and 38 or 400
    ts:Create(mainFrame, TweenInfo.new(0.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Size = UDim2.new(0, 560, 0, targetY)}):Play()
end)
...
function library:CreateTab(name)
    ...
    function elements:AddColorPicker(text, defaultColor, callback)
        ...
        local function createRgbSlider(name, colorVal, barColor)
            ...
            local lName = create("TextLabel", {Size = UDim2.new(0, 16, 1, 0), BackgroundTransparency = 1, Text = name, TextColor3 = Color3.fromRGB(200, 200, 200), Font = fontBold, TextSize = 13, Parent = sFrame})
...
create("TextLabel", {
    ...
    BackgroundTransparency = 1,
    Text = "Всё управление находится во вкладках Player и Settings. Nажми RightShift чтобы скрыть меню.",
    TextColor3 = Color3.fromRGB(170, 170, 170),
    Font = fontRegular,
    TextSize = 13,
    TextWrapped = true,
...
playerTab:AddSlider("Gravity", 0, 400, 196, function(val)
    savedGravity = val
end)
